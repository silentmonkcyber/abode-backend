...
def seed():
    ...
    with get_db() as conn:
        conn.executemany(
            ...
            [
                (1, "Priya Sharma", "Mumbai", 5, "Abode Renovators was a dream to work with.", 1),
                (2, "Rahul Mehra", "Bangalore", 5, "Incredibly professional team.", 1),
        ...
        conn.executemany(
            ...
            [
                ...
                (2, "Loft Minimal", "Pune", "Bedroom", "Clean lines for a calming retreat.", 0),
                (3, "Verde Living", "Bangalore", "Full Home", "Nature woven into every room.", 1),
                (4, "Terracotta Home", "Hyderabad", "Kitchen & Dining", "Rich terracotta hues.", 0),
                (5, "The Ivory Penthouse", "Delhi", "Full Home", "Luxurious ivory tones.", 1),
            ]
        )
