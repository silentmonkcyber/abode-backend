...
def seed():
    ...
    with get_db() as conn:
        conn.executemany(
            ...
            [
                (1, "Priya Sharma", "Mumbai", 5, "Working with Abode Renovators was a dream. They completely understood our vision.", 1),
                (2, "Rahul & Nidhi Mehra", "Bangalore", 5, "The team was incredibly professional and detail-oriented.", 1),
                (3, "Ananya Krishnan", "Pune", 5, "I gave them complete creative freedom and they delivered magic.", 1),
                (4, "Vikram Nair", "Delhi", 5, "Our home office makeover has genuinely changed how I work.", 1),
        ...
        conn.executemany(
            ...
            [
                ...
                (3, "Verde Living", "Bangalore", "Full Home", "A biophilic design weaving nature into every room.", 1),
